<template>
  <div class="xing-header">
    ...
    <xing-header-nav class="xing-header-nav" :styleList="headerNavList" :activeName="activeNavName"
      @click="goPage"></xing-header-nav>
    <!--搜索框-->
    <div class="header-search">
      <el-input placeholder="搜索" :prefix-icon="Search" v-model="keywords" @keyup.enter="goSearch()" />
    </div>
    <!--设置-->
    <xing-header-nav v-if="!token" :styleList="signList" :activeName="activeNavName" @click="goPage"></xing-header-nav>
...
import XingHeaderNav from "./XingHeaderNav.vue";
